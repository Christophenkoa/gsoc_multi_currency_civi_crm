...
<script type="text/javascript">
    CRM.$(function($) {
        $('.crm-membershiptype-form-block-minimum_fee').after('<td class="label"><label for="currencies">Currency</label></td><td class="six crm-form-text"><select name="currencies" id="currency"><option value="volvo">FCFA</option><option value="saab">Euro</option><option value="mercedes">Dollar</option><option value="audi">CAD</option></select></td><br><td class="label"><label>Set a minimum price</label></td><td><input type="text" class="six crm-form-text" id="minimum_amount" name="minimum_amount" value="0"></td>');
    });
